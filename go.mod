...
require (
	...
	github.com/celestiaorg/aws-kms-keyring v0.4.0 // indirect
	github.com/celestiaorg/celestia-app/v6 v6.4.10 // indirect
	github.com/celestiaorg/celestia-app/v7 v7.0.2-mocha // indirect
	github.com/celestiaorg/celestia-node v0.29.1-mocha // indirect
	...
	github.com/succinctlabs/sp1-blobstream v1.1.0 // indirect
